...
# Mel Frequency Cepstrum Coefficients Main code
## Useful while testing for someone's own voice and reconstructing his/her face
### Copyright (c) 2006 Carnegie Mellon University - can be copied and modified freely under the same terms as Sphinx-III
#### This module provides functions for computing MFCC (mel-frequency cepstral coefficients) as used in the Sphinx speech recognition system.
